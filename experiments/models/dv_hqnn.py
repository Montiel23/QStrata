...
class HybridSpineDVModel(nn.Module):
    def __init__(self, n_qubits, n_classes, pretrain_backbone=True):
        super().__init__()
        ...
        self.dv_quantum_classifier = DV_QNN_Spine_Classifier(n_qubits, n_classes)
    ...
    def forward(self, x):
        ...
        #contract the features to a low-dimensional 1D quantum input vector
        quantum_ready_vector = self.quantum_projection_head(latent_features)
